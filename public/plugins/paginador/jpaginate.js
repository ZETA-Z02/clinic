...
function initPaginador(nums, idtable, idpaginador) {
  var parametros = {
    items: nums,
    namecookies: "tabla",
    next: "<i class='fa-solid fa-caret-right' style='color:white'></i>",
    previous: "<i class='fa-solid fa-caret-left' style='color:white'></i>",
    inicial: "<i class='fa fa-angle-double-left' style='color:white'></i>",
    final: "<i class='fa fa-angle-double-right' style='color:white'></i>",
    minimize: true,
